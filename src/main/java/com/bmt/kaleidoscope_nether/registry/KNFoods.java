...
import static com.bmt.kaleidoscope_nether.registry.KNEffects.GLOWING;
import static com.bmt.kaleidoscope_nether.registry.KNEffects.TROPICAL_STRIDER;
...
//    //.effect(new MobEffectInstance((Holder<MobEffect>) GHOST, 240 * 20), 1.0F).build();
...
//            .effect(new MobEffectInstance(ModEffects.SULFUR, 90 * 20, 0), 1.0F)
    ...
    public static final FoodProperties MAGMA_CREAM_SOUP = new FoodProperties.Builder()
            .nutrition(6).saturationModifier(0.667f)
//            .effect(new MobEffectInstance(WARMTH, 480 * 20), 1.0F)
            .alwaysEdible()
            .build();
...
//            .effect(new MobEffectInstance(WARMTH, 180 * 20), 1.0F)
            .alwaysEdible()
            .build();
...
//            .effect(new MobEffectInstance(STAR_BLESSING, 600, 0), 1.0F)
    ...
    public static final FoodProperties GLOWING_SOUP = new FoodProperties.Builder()
            .nutrition(6).saturationModifier(0.667f)
//            .effect(new MobEffectInstance(GLOWING, 180 * 20), 1.0F)
            .alwaysEdible()
            .build();
...
//            .effect(new MobEffectInstance(GLOWING, 180 * 20), 1.0F)
    ...
    public static final FoodProperties GLOWING_KABOB = new FoodProperties.Builder()
            .nutrition(4).saturationModifier(0.55f)
//            .effect(new MobEffectInstance(GLOWING, 45 * 20), 1.0F)
            .alwaysEdible()
            .build();
    ...
    public static final FoodProperties GLOWING_SALAD = new FoodProperties.Builder()
            .nutrition(6).saturationModifier(0.55f)
//            .effect(new MobEffectInstance(GLOWING, 90 * 20), 1.0F)
            .alwaysEdible()
            .build();
...
//            .effect(new MobEffectInstance(WARPED, 60 * 20), 1.0F)
    ...
    public static final FoodProperties CHONGQING_NOODLES = new FoodProperties.Builder()
            .nutrition(14).saturationModifier(0.643f)
            .alwaysEdible()
//            .effect(new MobEffectInstance(WARMTH, 3600), 1.0F)
            .build();
