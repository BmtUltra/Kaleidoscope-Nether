...
public class SatiatedShieldBuffFoodItem extends Item {
    private final int buffDuration;

    public SatiatedShieldBuffFoodItem(FoodProperties food, int buffDurationInSeconds) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag flag) {
        ...
        tooltipComponents.add(Component.translatable(translationKey).withStyle(ChatFormatting.GREEN));
    }
