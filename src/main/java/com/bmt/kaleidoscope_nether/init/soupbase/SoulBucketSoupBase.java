...
public class SoulBucketSoupBase implements ISoupBase {
    ...
    public ItemStack getDisplayStack() {
        return new ItemStack(com.bmt.kaleidoscope_nether.init.KNItems.SOUL_BUCKET.get());
    }

    @Override
    public boolean isSoupBase(ItemStack stack) {
        return stack.getItem() == com.bmt.kaleidoscope_nether.init.KNItems.SOUL_BUCKET.get();
    }
