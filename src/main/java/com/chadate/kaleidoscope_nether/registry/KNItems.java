...
import com.chadate.kaleidoscope_nether.item.*;
import com.chadate.kaleidoscope_nether.item.EffectItem.*;
import com.chadate.kaleidoscope_nether.item.SpecialFood.*;
import com.chadate.kaleidoscope_nether.item.Tier.PrimitiveMacheteTier;
...
public class KNItems {
    ...
    public static final DeferredHolder<Item, Item> COOK_STOOL_WART = ITEMS.register("cook_stool_wart",
            () -> new BlockItem(KNBlocks.COOK_STOOL_WART.get(), new Item.Properties()));

    public static final DeferredHolder<Item, Item> TABLE_WART = ITEMS.register("table_wart",
    ...
    // 巨兽牛角包
    public static final DeferredHolder<Item, Item> GIANT_BEAST_CROISSANT = ITEMS.register("giant_beast_croissant",
            () -> new CataclysmBuffFoodItem(KNFoods.GIANT_BEAST_CROISSANT, 240));

    // 魔眼咕噜肉
    public static final DeferredHolder<Item, Item> MAGMA_SWEET_AND_SOUR_PORK = ITEMS.register("magma_sweet_and_sour_pork",
    ...
    // 红烧狮子头
    public static final DeferredHolder<Item, Item> BRAISED_LION_HEAD = ITEMS.register("braised_lion_head",
    ...
    // 卤肉饭
    public static final DeferredHolder<Item, Item> BRAISED_PORK_RICE = ITEMS.register("braised_pork_rice",
    ...
    /*
        // 广式肠粉
        public static final DeferredHolder<Item, Item> CANTONESE_RICE_NOODLE_ROLL = ITEMS.register("cantonese_rice_noodle_roll",
