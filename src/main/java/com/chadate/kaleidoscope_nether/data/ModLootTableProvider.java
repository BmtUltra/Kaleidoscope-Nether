...
public class ModLootTableProvider extends LootTableProvider {
    ...
    public static class BlockLoots extends BlockLootSubProvider {
        ...
        protected void generate() {
            ...
            simpleCropBlockLoot(KNBlocks.SOUL_PEPPER.get(), ModItems.CHILI_SEED.get(), KNItems.SOUL_PEPPER.get());
            ...
            // Furniture and decoration blocks that drop themselves
            this.dropSelf(KNBlocks.NETHER_STOVE.get());
            this.dropSelf(KNBlocks.CHAIR_WART.get());
            this.dropSelf(KNBlocks.COOK_STOOL_WART.get());
            this.dropSelf(KNBlocks.TABLE_WART.get());
        ...
        protected @NotNull Iterable<Block> getKnownBlocks() {
            ...
            blocks.addAll(KNBlocks.BLOCKS.getEntries().stream().map(DeferredHolder::get).toList());
