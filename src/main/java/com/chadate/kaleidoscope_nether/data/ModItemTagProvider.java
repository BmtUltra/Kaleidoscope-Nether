...
import com.chadate.kaleidoscope_nether.api.KNTags;
...
public class ModItemTagProvider extends ItemTagsProvider {
    public ModItemTagProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> completableFuture1, CompletableFuture<TagLookup<Block>> completableFuture2, ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(KNTags.Items.SOUL_PEPPER_TRANSFORMABLE)
                .add(
                        ModItems.RED_CHILI.get(),
                        ModItems.GREEN_CHILI.get()
                );
